...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        state = addstr(waypoint) + "_" + inputs['light'] + "_" + addstr(inputs['left']) + "_" + addstr(inputs['oncoming'])
        if self.learning:
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True, alpha=0.96, epsilon=1)
